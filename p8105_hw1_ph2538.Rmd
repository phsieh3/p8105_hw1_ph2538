...
* The mean of x is `r mean(df_normal$x)`.
* The median of x is `r median(df_normal$x)`.
...
```
The color scale is binary. There is one color for False and one color for True. There is a very clear split between the two colors.
